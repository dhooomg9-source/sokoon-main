      ...
      <div className="w-full max-w-5xl mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <button
            ...
            className={`p-8 rounded-[2rem] text-left transition-all duration-300 border-2 ${approach === 'during' ? 'border-accent bg-accent text-paper shadow-xl scale-[1.02]' : 'border-dark bg-paper text-dark hover:shadow-md'
              }`}
          >
          ...
          <button
            ...
            className={`p-8 rounded-[2rem] text-left transition-all duration-300 border-2 ${approach === 'after' ? 'border-accent bg-accent text-paper shadow-xl scale-[1.02]' : 'border-dark bg-paper text-dark hover:shadow-md'
              }`}
          >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {['schools', 'highrise', 'consultancy', 'hospitals'].map(sec => (
              <button
                ...
                className={`p-6 rounded-[1.5rem] font-heading font-black uppercase tracking-tight text-lg sm:text-xl transition-all duration-300 border-2 ${sector === sec ? 'border-accent bg-accent text-paper shadow-xl scale-[1.05]' : 'border-dark bg-paper text-dark hover:-translate-y-1 shadow-sm'
                  }`}
              >
        ...
        <div ref={productRef} className="w-full max-w-5xl mb-16 bg-paper p-8 md:p-12 rounded-[3rem] shadow-xl border-2 border-dark/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {activeProducts.map((prod) => (
              <div key={prod.id} className="p-6 bg-background rounded-[1.5rem] border-2 border-dark/20 shadow-md hover:border-dark hover:shadow-xl transition-all duration-300">
          ...
          <button
            ...
            className="btn-magnetic w-full md:w-auto px-10 py-5 bg-accent text-paper rounded-[2rem] font-heading font-black text-xl shadow-2xl border-2 border-accent hover:scale-[1.02] transition-all duration-300"
          >
