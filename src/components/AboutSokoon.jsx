...
export default function AboutSokoon() {
  ...
  return (
    <section ref={containerRef} className="py-24 px-6 md:px-12 lg:px-24 bg-card max-w-7xl mx-auto rounded-[3rem] shadow-xl my-12 border border-primary/5">
      <div className="flex flex-col items-center text-center mb-16 about-reveal">
        <h2 className="font-heading font-bold text-4xl md:text-5xl lg:text-6xl text-accent uppercase tracking-tighter mb-6">
          About SOKOON
        </h2>
        <p className="font-body text-lg md:text-xl text-slate-600 max-w-3xl leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="about-reveal p-10 rounded-[2rem] bg-body border border-subtle hover:border-accent transition-colors duration-500 group">
          <h3 className="font-heading font-bold text-2xl mb-4 text-primary flex items-center gap-3">
            <span className="w-8 h-[2px] bg-accent inline-block"></span> Vision Statement
          </h3>
          <p className="font-data text-sm md:text-base text-slate-600 leading-relaxed">
