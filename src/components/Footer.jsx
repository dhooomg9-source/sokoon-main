...
export default function Footer() {
  return (
    <footer className="w-full bg-midnight-flow text-on-dark rounded-t-[4rem] px-8 py-16 md:py-24 relative z-20 flex flex-col mt-32 border-t border-subtle/20">
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-5 gap-12">
        <div className="md:col-span-2 flex flex-col gap-6">
          ...
          <p className="font-data text-slate-400 max-w-sm text-sm">
          ...
          <div className="mt-8 flex items-center gap-3 font-data text-xs text-emerald-400 uppercase tracking-widest bg-card/5 w-max px-4 py-2 rounded-full border border-card/10">
        ...
        <div className="flex flex-col gap-4 font-data text-sm">
          <h4 className="font-heading font-bold uppercase text-slate-400 mb-2">Navigation</h4>
        ...
        <div className="flex flex-col gap-4 font-data text-sm">
          <h4 className="font-heading font-bold uppercase text-slate-400 mb-2">Legal</h4>
        ...
        <div className="flex flex-col gap-4 font-data text-sm">
          <h4 className="font-heading font-bold uppercase text-slate-400 mb-2">Contact Us</h4>
          ...
          <span className="text-slate-300">Riyadh, Saudi Arabia</span>
        </div>
      </div>

      <div className="max-w-7xl mx-auto w-full mt-24 pt-8 border-t border-card/10 text-center font-data text-xs text-on-dark/30 uppercase">
